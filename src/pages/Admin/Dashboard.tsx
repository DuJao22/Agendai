      ...
      tenantFetch(tenantSlug, '/api/settings')
        ...
        .then(data => {
          if (!data.error) {
            setSettings(prev => ({
              ...prev,
              profile_name: data.profile_name || 'Barbearia Premium',
              cover_photo: data.cover_photo || '',
              profile_photo: data.profile_photo || '',
              subtitle: data.subtitle || 'Estilo e Tradição para o Homem Moderno ✂️💈',
              services_title: data.services_title || 'Nossos Serviços',
              services_subtitle: data.services_subtitle || 'Escolha o serviço ideal para o seu visual.',
